...
5. **Route its proof** from this period's stated proof inventory; where the period states none, mark the route **unverified for the period** rather than assuming one.
