...
**No reserved-zone rules.** The old reserved clean text zone is **retired** — you do **not** reserve, keep clean, or size any text plane. The Text step renders text via a deterministic diacritic-safe overlay that needs no pre-cleared plane; any headroom for text is a free *framing* choice, never a geometry demand.
