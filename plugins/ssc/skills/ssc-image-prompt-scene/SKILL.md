...
**Grounded on contents:** <"dựng CHÍNH trên <n> copy đã duyệt, có <các section khác> + brief hỗ trợ (chỉ lấy ý + tông, không nêu chữ)" | "chưa có nội dung đã duyệt — dựng theo brief + persona (nên chạy /ssc.ads-produce <brief_id> copy — hoặc /ssc.post <brief_id> với bài viết — để sắc hơn)">
