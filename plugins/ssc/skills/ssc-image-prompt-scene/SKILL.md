...
**If a gate STOPPED at Step 1** (brief not found; non-ad idea; concept or brief not approved), or the save was rejected, emit that stop message plainly — the reason and the exact next action, in Vietnamese. **Produce no image, spend no credits.** *(Step 2 never STOPs — this layer's own state is not a gate.)*
