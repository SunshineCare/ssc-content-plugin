...
Self-rate each candidate finding before saving: `score` — an integer 1–5 for how strong/actionable this KOL candidate is (persona fit + tone alignment + audience quality) — and a Vietnamese `comment` explaining that score.
